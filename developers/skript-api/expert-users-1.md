...
* Установите [skript](https://github.com/SkriptLang/Skript/releases/latest)
* Установите [skript-reflect](https://github.com/TPGamesNL/skript-reflect/releases/latest)

{% hint style="info" %}
Чтобы получить больше информации о **skript-reflect**, пожалуйста, прочитайте его [wiki](https://tpgamesnl.gitbook.io/skript-reflect/)
{% endhint %}

{% hint style="danger" %}
#### Пожалуйста, **не обращайтесь** за **поддержкой** по проблемам и вопросам, связанным с **скриптом**.

Я не эксперт по скрипту и не являюсь разработчиком **скрипта** или **скрипта-отражения**.\
**Все вопросы о скрипте будут проигнорированы**, надеюсь, вы понимаете.
{% endhint %}
