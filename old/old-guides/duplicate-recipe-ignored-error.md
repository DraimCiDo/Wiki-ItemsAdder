# Ошибка "Duplicate recipe ignored"

Если вы получаете ошибку, подобную этой, пожалуйста, обновите ваш Paper или Spigot до ПОСЛЕДНЕЙ версии. Если это версия 1.14.4, это не значит, что она обновлена, вы должны загрузить самую последнюю версию.
